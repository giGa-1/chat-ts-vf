...
const page = async ({ params }: pageProps) => {
  ...
  return <div className='flex-1 justify-between flex flex-col h-full max-h-[calc(100vh-6rem)] '>
    <div className="flex sm:items-center justufy-between px-3 py-3 border-b-2 border-gray-200">
    ...
    <Messages initialMessages={initialMessages} session={session.user.id}/>
